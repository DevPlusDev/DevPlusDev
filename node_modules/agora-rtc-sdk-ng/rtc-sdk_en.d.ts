...
export declare interface IAgoraRTCClient extends EventEmitter {
     ...
     *
     * <div class="alert warning">To ensure better end-user experience, Agora highly suggests not using a string as the user ID.</div>
     *
     * > Note:
 ...
 *
 * 默认值
 *   |`cds.hostname`| `accessPoints` 所包含的主机名列表|
 *   |`cds.port`|443|
 */
